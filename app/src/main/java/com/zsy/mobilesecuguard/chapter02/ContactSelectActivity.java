package com.zsy.mobilesecuguard.chapter02;
...
import com.zsy.mobilesecuguard.chapter02.adapter.ContactAdapter;
import com.zsy.mobilesecuguard.chapter02.entity.ContactInfo;
import com.zsy.mobilesecuguard.chapter02.utils.ContactInfoParser;
...
public class ContactSelectActivity extends Activity implements OnClickListener {
    ...
    private void initView() {
        ...
        //设置导航栏颜色
        findViewById(R.id.rl_titlebar).setBackgroundColor(ContextCompat.getColor(this, R.color.purple));
