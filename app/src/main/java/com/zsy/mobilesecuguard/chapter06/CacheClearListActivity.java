package com.zsy.mobilesecuguard.chapter06;
...
import com.zsy.mobilesecuguard.chapter06.adapter.CacheCleanAdapter;
...
public class CacheClearListActivity extends Activity implements OnClickListener {
    ...
    private void initView() {
        findViewById(R.id.rl_titlebar).setBackgroundColor(ContextCompat.getColor(this, R.color.rose_red));
        ...
        thread = new Thread() {
            ...
            public void run() {
                ...
                for (PackageInfo info : infos) {
                    getCacheSize(info);     //根据packageName获取cache大小, 添加cacheinfo到cacheinfos
                    try {
                        Thread.sleep(500);
