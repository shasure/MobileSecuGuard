...
import com.zsy.mobilesecuguard.chapter02.ContactSelectActivity;
...
public class AddBlackNumberActivity extends Activity implements OnClickListener {
	...
	private void initView() {
		findViewById(R.id.rl_titlebar).setBackgroundColor(ContextCompat.getColor(this, R.color.bright_purple));
