package com.zsy.mobilesecuguard.chapter07;
...
import com.zsy.mobilesecuguard.chapter07.adapter.ProcessManagerAdapter;
import com.zsy.mobilesecuguard.chapter07.entity.TaskInfo;
import com.zsy.mobilesecuguard.chapter07.utils.SystemInfoUtils;
import com.zsy.mobilesecuguard.chapter07.utils.TaskInfoParser;
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (userTaskInfos.size() > 0) {
                            mProcessNumTV.setText(String.format("用户进程： %d个", userTaskInfos.size()));
                        } else {
                            mProcessNumTV.setText(String.format("系统进程：%d个", sysTaskInfo.size()));
                        }
                    }
                });
            }
