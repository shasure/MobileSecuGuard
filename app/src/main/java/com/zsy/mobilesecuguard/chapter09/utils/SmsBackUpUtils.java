package com.zsy.mobilesecuguard.chapter09.utils;
...
public class SmsBackUpUtils {
    ...
    public boolean backUpSms(Context context, BackupStatusCallback callback)
        ...
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED) && freesize > 1024l * 1024l) {
            File file = new File(Environment.getExternalStorageDirectory(), "backup.xml");
            Log.i(Configure.TAG, "ExternalStorageDirectory file: " + file.getPath());
...
//                    String bodyencpyt = Crypto.encrypt("123", cursor.getString(1));
                    String bodyencpyt = cursor.getString(1);
