package com.zsy.mobilesecuguard.chapter09.service;
...
import com.zsy.mobilesecuguard.chapter09.EnterPswActivity;
...
public class AppLockService extends Service {
    ...
    public void onCreate() {
        ...
        IntentFilter filter = new IntentFilter("com.zsy.mobilesecuguard.applock");
    ...
    class AppLockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.zsy.mobilesecuguard.applock".equals(intent.getAction())) {
                //暂时解锁当前应用，为了不让密码锁界面第二次弹出
